...
function login(username,password,callback) {
    ...
    https.get('http://cca-kaswan-webchatservices.herokuapp.com/login/' +username + '/' +password,(resp)=>{
        let data = "";
        resp.on('data', (chunk)=>{
            data +=chunk ;
        });
...
function register(fullname,username,email,password,callback){
    https.get('http://cca-kaswan-webchatservices.herokuapp.com/register/'+fullname+'/'+username+'/'+email+'/'+password,(resp)=>{
        let data = '';
        resp.on('data',(chunk)=>{
            data += chunk;
        });
